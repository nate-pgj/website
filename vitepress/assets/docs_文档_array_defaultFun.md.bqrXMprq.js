import{_ as s,c as a,o as n,V as e}from"./chunks/framework.meLkqabe.js";const b=JSON.parse('{"title":"数组默认函数","description":"","frontmatter":{},"headers":[],"relativePath":"docs/文档/array_defaultFun.md","filePath":"docs/文档/array_defaultFun.md","lastUpdated":1705911118000}'),p={name:"docs/文档/array_defaultFun.md"},t=e(`<h1 id="数组默认函数" tabindex="-1">数组默认函数 <a class="header-anchor" href="#数组默认函数" aria-label="Permalink to &quot;数组默认函数&quot;">​</a></h1><h2 id="_1-at" tabindex="-1">1.at <a class="header-anchor" href="#_1-at" aria-label="Permalink to &quot;1.at&quot;">​</a></h2><p>获取特定索引处的元素。</p><p>负索引表示从末尾开始计数（例如：-1 是最后一个元素）。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span></span></span>
